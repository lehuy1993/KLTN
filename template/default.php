...
<?php 
        ...
        $result = mysqli_query($conn, 'select count(id) as total from truyen');
        ...
        $result = mysqli_query($conn, "SELECT * FROM truyen LIMIT $start, $limit");
...
<section class="section-breadcrumbs">
	...
	<div class="product-gird">
		<a class="product-img" href="?options=sanpham&idsp=<?php echo $row['id'] ?>" title="<?php echo $row['ten'] ?>">
			 <img src="<?php echo __ImagePro.$row1[0]['anh_bia']; ?>" alt="<?php echo $row['ten']; ?>"  "/>
		</a>
		<h3 class="product-name">
			<a href="?options=sanpham&idsp=<?php echo $row['id'] ?>" title="<?php echo $row['ten'] ?>"><?php echo $row['ten'] ?></a>
		</h3>
